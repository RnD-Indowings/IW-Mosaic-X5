...
#include "septentrio_gnss_driver/msg/detail/meas_epoch__rosidl_typesupport_fastrtps_c.h"
...
#include "septentrio_gnss_driver/msg/detail/meas_epoch_channel_type1__functions.h"  // type1
...
using _MeasEpoch__ros_msg_type = septentrio_gnss_driver__msg__MeasEpoch;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MeasEpoch__ros_msg_type * ros_message = static_cast<const _MeasEpoch__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: sb1_length
  {
    cdr << ros_message->sb1_length;
  }

  // Field name: sb2_length
  {
    cdr << ros_message->sb2_length;
  }

  // Field name: common_flags
  {
    cdr << ros_message->common_flags;
  }

  // Field name: cum_clk_jumps
  {
  ...
  // Field name: type1
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, septentrio_gnss_driver, msg, MeasEpochChannelType1
      )()->data);
    size_t size = ros_message->type1.size;
    auto array_ptr = ros_message->type1.data;
  ...
  void * untyped_ros_message)
{
  ...
  _MeasEpoch__ros_msg_type * ros_message = static_cast<_MeasEpoch__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: type1
  {
    ...
    if (ros_message->type1.data) {
      septentrio_gnss_driver__msg__MeasEpochChannelType1__Sequence__fini(&ros_message->type1);
    }
    if (!septentrio_gnss_driver__msg__MeasEpochChannelType1__Sequence__init(&ros_message->type1, size)) {
      fprintf(stderr, "failed to create array for field 'type1'");
      return false;
    }
    auto array_ptr = ros_message->type1.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_septentrio_gnss_driver__msg__MeasEpoch(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MeasEpoch__ros_msg_type * ros_message = static_cast<const _MeasEpoch__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name type1
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_septentrio_gnss_driver__msg__MeasEpochChannelType1(
...
static uint32_t _MeasEpoch__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_septentrio_gnss_driver__msg__MeasEpoch(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_septentrio_gnss_driver
size_t max_serialized_size_septentrio_gnss_driver__msg__MeasEpoch(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: type1
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_septentrio_gnss_driver__msg__MeasEpochChannelType1(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = septentrio_gnss_driver__msg__MeasEpoch;
    is_plain =
      (
      offsetof(DataType, type1) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _MeasEpoch__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_septentrio_gnss_driver__msg__MeasEpoch(
...
static message_type_support_callbacks_t __callbacks_MeasEpoch = {
...
static rosidl_message_type_support_t _MeasEpoch__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MeasEpoch,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, septentrio_gnss_driver, msg, MeasEpoch)() {
  return &_MeasEpoch__type_support;
}
