...
#include "septentrio_gnss_driver/msg/detail/att_euler__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = septentrio_gnss_driver::msg::AttEuler;
    is_plain =
      (
      offsetof(DataType, heading_dot) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const septentrio_gnss_driver::msg::AttEuler *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<septentrio_gnss_driver::msg::AttEuler *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AttEuler__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const septentrio_gnss_driver::msg::AttEuler *>(
...
static size_t _AttEuler__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AttEuler(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AttEuler__callbacks = {
...
static rosidl_message_type_support_t _AttEuler__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AttEuler__callbacks,
...
get_message_type_support_handle<septentrio_gnss_driver::msg::AttEuler>()
{
  return &septentrio_gnss_driver::msg::typesupport_fastrtps_cpp::_AttEuler__handle;
}
