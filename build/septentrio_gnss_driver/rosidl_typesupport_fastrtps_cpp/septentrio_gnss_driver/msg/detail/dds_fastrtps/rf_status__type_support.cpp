...
#include "septentrio_gnss_driver/msg/detail/rf_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const septentrio_gnss_driver::msg::RFBand &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  septentrio_gnss_driver::msg::RFBand &);
size_t get_serialized_size(
  const septentrio_gnss_driver::msg::RFBand &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const septentrio_gnss_driver::msg::RFStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  septentrio_gnss_driver::msg::RFStatus & ros_message)
{
  // Member: header
  ...
  // Member: rfband
  {
    ...
    ros_message.rfband.resize(size);
    for (size_t i = 0; i < size; i++) {
      septentrio_gnss_driver::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.rfband[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: rfband
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        septentrio_gnss_driver::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.rfband[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: rfband
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        septentrio_gnss_driver::msg::typesupport_fastrtps_cpp::max_serialized_size_RFBand(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = septentrio_gnss_driver::msg::RFStatus;
    is_plain =
      (
      offsetof(DataType, rfband) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const septentrio_gnss_driver::msg::RFStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<septentrio_gnss_driver::msg::RFStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RFStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const septentrio_gnss_driver::msg::RFStatus *>(
...
static size_t _RFStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RFStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RFStatus__callbacks = {
...
static rosidl_message_type_support_t _RFStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RFStatus__callbacks,
...
{
  return &septentrio_gnss_driver::msg::typesupport_fastrtps_cpp::_RFStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, septentrio_gnss_driver, msg, RFStatus)() {
  return &septentrio_gnss_driver::msg::typesupport_fastrtps_cpp::_RFStatus__handle;
}
